...
class Weather {
    ...
    constructor(botConfig) {
        ...
        // add recognizers
        const luisWeatherServiceName = WEATHER_LUIS_CONFIGURATION; //botConfig.name + '_' + WEATHER_LUIS_CONFIGURATION;
    ...
    async onTurn(turnContext) {
        ...
        case GET_CONDITION_INTENT:
            await turnContext.sendActivity(`You asked for current weather condition in Location = ` + (locationPatternAnyEntity?locationPatternAnyEntity:locationEntity) );
